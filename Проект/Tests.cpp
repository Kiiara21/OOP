...
//     TEST_CASE("my pow tests"){
//         CHECK_EQ(Utils::myPow(2, 3), 8);
//         CHECK_EQ(Utils::myPow(2, 2), 4);
//         CHECK_EQ(Utils::myPow(3, 3), 27);
//         CHECK_EQ(Utils::myPow(3, 2), 9);
//     }
// }
...
//     TEST_CASE("Getter for id"){
//         Row row1, row2;
//         CHECK_EQ(row1.getId(), 1);
//         CHECK_EQ(row2.getId(), 2);
//     }
