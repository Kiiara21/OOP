...
public:
    ...
    static bool isDoubleInteger(double number);
    ...
    static Cell* convertedValue(const std::string& str); // formula without references
    ...
    static int myPow(const double base, double exponent);
